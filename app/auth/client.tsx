...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your ClientNest Account",
        description: "Start managing your clients and deals today",
    ...
    return {
      id: "signin",
      title: "Sign in to ClientNest",
      description: "Access your CRM dashboard",
      button: "Sign In",
      bottomText: "Don’t have an account?",
      bottomLink: "/auth#signup",
      bottomLinkText: "Create one for your team."
    };
  }, [mode]);
        ...
        <div className="flex min-h-[720px] items-center justify-center p-4 sm:p-8 lg:p-10">
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            ...
            <div className="flex flex-col items-center mt-6">
              <span className="text-xs text-muted-foreground">Your information is safe with ClientNest.</span>
              <div className="py-3 text-sm">
                {mode === "signin" ? (
                  <span>
                    {content.bottomText}{" "}
                    <Link className="underline hover:text-primary" href={content.bottomLink}>
